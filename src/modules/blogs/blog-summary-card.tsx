    ...
    >
      ...
      {publishedOn && (
        <time
          ...
          className="font-jetbrains-mono bg-gradient-rainbow-light rounded border border-gray-300 px-1 text-sm text-gray-500 tabular-nums dark:border-gray-600 dark:bg-gray-900 dark:text-white"
        >
