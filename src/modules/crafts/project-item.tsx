...
const ProjectItem = ({
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="absolute inset-0 top-0 left-0 z-10 scale-95 transform rounded-3xl bg-white opacity-0 transition-all duration-200 ease-out group-hover:scale-100 group-hover:opacity-100"
      />
