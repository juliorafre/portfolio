...
const JournalCard = ({
  ...
  return (
    <div
      className={
        'md:-ml-4 inset-shadow-neutral-200 inset-shadow-sm my-2 w-full rounded-lg bg-neutral-100 px-4 py-3 md:w-[calc(100%_+_2rem)] dark:inset-shadow-none dark:border dark:border-neutral-800 dark:bg-neutral-800'
      }
    >
