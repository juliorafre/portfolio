...
const baseStyles: HTMLAttributes<HTMLElement>["className"] = cn(
  "relative inline gap-0.5 rounded-none py-[0.5px] pr-1 pl-1.5 font-normal text-black",
...
const baseStylesProtera: HTMLAttributes<HTMLElement>["className"] = cn(
  "relative inline gap-0.5 rounded-none pr-1 pl-1.5 py-1 font-normal text-white",
