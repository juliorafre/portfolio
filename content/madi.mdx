...
<CaseStudiesHeader
  ...
  company={{ name: 'Protera', url: 'https://www.linkedin.com/company/protera-bio/posts/?feedView=all' }}
  platform="Web"
...
<div className="w-full grid place-items-center">
  <img
    alt="protera team"
    className="md:w-1/2 w-[80%] shadow-xl border-10 border-white transform -rotate-z-3"
    src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/protera-team.png"
  />
</div>
