...
<ImagePost src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/header.png" alt="madi blog header" height={1000} priority width={1000} />
...
>
  <div className="flex-[0_0_95%] snap-start snap-always md:flex-[0_0_50%]">
    <ImagePost src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/factory-01.png" alt="factory example 1" width={1400} height={1000} />
  </div>
  <div className="flex-[0_0_95%] snap-start snap-always md:flex-[0_0_50%]">
    <ImagePost src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/factory-02.png" alt="factory example 2" width={1400} height={1000} />
  </div>
  <div className="flex-[0_0_95%] snap-start snap-always md:flex-[0_0_50%]">
    <ImagePost src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/factory-03.png" alt="factory example 3" width={1400} height={1000} />
  </div>
</div>
...
>
  <div className="flex-[0_0_95%] snap-start snap-always md:flex-[0_0_50%]">
    <ImagePost src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/discovery-01.png" alt="discovery example 1" width={1000} height={1000} />
  </div>
  <div className="flex-[0_0_95%] snap-start snap-always md:flex-[0_0_50%]">
    <ImagePost src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/discovery-02.png" alt="discovery example 2" width={1000} height={1000} />
  </div>
  <div className="flex-[0_0_95%] snap-start snap-always md:flex-[0_0_50%]">
    <ImagePost src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/discovery-03.png" alt="discovery example 3" width={1000} height={1000} />
  </div>
</div>
...
<div className="w-full grid place-items-center">
  <img alt="protera team" className="md:w-1/2 w-[80%] shadow-xl border-10 border-white transform -rotate-z-3"  src="https://res.cloudinary.com/juliorafrecloud/image/upload/v1751207656/Portfolio/blog/madi/protera-team.png" />
</div>