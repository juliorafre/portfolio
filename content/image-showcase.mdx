...
abstract: 'A showcase of images'
publishedOn: '2025-05-30'
author: 'Julio Ramirez'
tags: ['images', 'showcase', 'carousel', 'gallery']
published: false
slug: 'image-showcase'
type: 'blog'
---
...
const ImageShowcase = () => {
  ...
  return (
    <div className="inset-shadow-lg @container/image-showcase relative aspect-video min-h-[280px] w-full overflow-hidden rounded-2xl border border-neutral-300 bg-neutral-200" ref={containerRef}>
