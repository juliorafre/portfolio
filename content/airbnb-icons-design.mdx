...
Probablemente hayas visto el ultimo keynote de Airbnb, donde presentaron actualizaciones para sus servicios y muchas otras cosas. Sin embargo no vengo a hablar sobre los updates de Airbnb si no algo que les intereso mas de uno por X, los nuevos iconos animados, por lo que estuvo unos minutos en ChatGPT generando un prompt que los generara.
